...
[`v0.3.2` release notes](https://github.com/Daviiap/go-tpm-tools/releases/tag/v0.3.2)
...
[Releases Page](https://github.com/Daviiap/go-tpm-tools/releases),
click [Draft a New Release](https://github.com/Daviiap/go-tpm-tools/releases/new).
...
The tags should then be visible at https://github.com/Daviiap/go-tpm-tools/tags
